...
public final class RuntimeMappingLoader {
    ...
    public RuntimeMapping loadDefault() { return loadBytes(resource("jacamo-use-runtime-mapping-draft.json")); }
    ...
    public RuntimeMapping loadBytes(byte[] input) {
        ...
        try {
            ...
            JSON.readTree(bytes); // Reject duplicate JSON keys before schema validation.
